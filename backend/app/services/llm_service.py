...
class OllamaLLMService:
    ...
    def send_message(self, message: str, conversation_history: List[Dict] = None, 
        ...
        try:
            ...
            conversation_prompt = self.prompt_manager.load_prompt(
                mode="conversation",
                prompt_type="system",
                language=language
    ...
    def generate_diary_entry(self, conversation_history: List[Dict], language: str = 'en', 
        ...
        try:
            ...
            diary_prompt = self.prompt_manager.load_prompt(
                mode="diary",
    ...
    def correct_grammar(self, text: str, language: str = 'en') -> str:
        ...
        try:
            ...
            grammar_prompt = self.prompt_manager.load_prompt(
                mode="grammar",
    ...
    def improve_writing(self, text: str, improvement_type: str, language: str = 'en') -> str:
        ...
        try:
            ...
            improvement_prompt = self.prompt_manager.load_prompt(
                mode="writing",
